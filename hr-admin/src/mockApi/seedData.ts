    ...
    children: [
      {
        ...
        children: [
          { id: '1-1-1', name: '运维组', parentId: '1-1', manager: '孙浩', managerPhone: '133****8007', employeeCount: 1, createTime: '2026-03-02' },
          { id: '1-1-2', name: '产品组', parentId: '1-1', manager: '黄磊', managerPhone: '125****8015', employeeCount: 0, createTime: '2026-03-09' },
        ],
      },
      { id: '1-2', name: '市场部', parentId: '1', manager: '郑丽', managerPhone: '130****8010', employeeCount: 3, createTime: '2026-01-12' },
      { id: '1-3', name: '销售部', parentId: '1', manager: '马超', managerPhone: '129****8011', employeeCount: 3, createTime: '2026-01-20' },
      { id: '1-4', name: '人事部', parentId: '1', manager: '刘芳', managerPhone: '136****8004', employeeCount: 3, createTime: '2026-02-03' },
      { id: '1-5', name: '财务部', parentId: '1', manager: '赵敏', managerPhone: '134****8006', employeeCount: 2, createTime: '2026-02-18' },
    ],
  },
];
