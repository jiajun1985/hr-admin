...
export type IconName = 
  | 'home' | 'user' | 'users' | 'department' | 'insurance' | 'medical' | 'points' | 'gift'
  | 'settings' | 'search' | 'bell' | 'question-circle' | 'plus' | 'import' | 'export'
  | 'edit' | 'delete' | 'eye' | 'filter' | 'arrow-down' | 'arrow-right' | 'arrow-up' | 'arrow-left'
  | 'check' | 'close' | 'chevron-down' | 'chevron-right' | 'chevron-up' | 'chevron-left'
  | 'warning' | 'info' | 'error' | 'success' | 'loading' | 'more' | 'calendar'
  | 'download' | 'upload' | 'refresh' | 'copy' | 'external-link' | 'mail' | 'phone'
  | 'menu' | 'dashboard' | 'birthday' | 'medal' | 'card' | 'bill' | 'announcement'
